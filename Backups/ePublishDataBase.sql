...
CREATE TABLE IF NOT EXISTS `e_publish`.`promotions` (
  ...
  `lib` VARCHAR(45) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `e_publish`.`gestion_annees` (
  ...
  `annee_debut` YEAR(4) NULL DEFAULT NULL,
  `annee_fin` YEAR(4) NULL DEFAULT NULL,
  `annee_format` VARCHAR(45) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `e_publish`.`session_actives` (
  ...
  `statut` ENUM('0', '1') NULL DEFAULT NULL,
  `date_active` DATETIME NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `e_publish`.`codes` (
  ...
  `id_sessions` INT(11) NOT NULL,
  `active` ENUM('0', '1') NULL DEFAULT NULL,
  `statut` ENUM('0', '1') NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `e_publish`.`bulletins` (
  ...
  INDEX `fk_bulletins_session_actives` (`id_session_active` ASC),
  ...
  CONSTRAINT `fk_bulletins_etudiants1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_bulletins_session_actives`
    FOREIGN KEY (`id_session_active`)
    REFERENCES `e_publish`.`session_actives` (`idsession_active`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `e_publish`.`ventes` (
  ...
  `id_code` INT(11) NOT NULL,
  `date_vente` DATETIME NULL DEFAULT CURRENT_TIMESTAMP,
